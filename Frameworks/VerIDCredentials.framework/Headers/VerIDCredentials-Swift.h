...
/// Barcode encoding
typedef SWIFT_ENUM(NSInteger, BarcodeEncoding, closed) {
...
/// Barcode format
typedef SWIFT_ENUM(NSInteger, BarcodeFormat, closed) {
...
typedef SWIFT_ENUM(NSInteger, IDCaptureSessionStatus, closed) {
...
/// ISO card format
typedef SWIFT_ENUM(NSInteger, ISOCardFormat, closed) {
